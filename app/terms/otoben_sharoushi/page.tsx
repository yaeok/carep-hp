              ...
              <div className="w-full lg:w-2/3 bg-white rounded-3xl shadow-xl shadow-gray-300 p-4 md:p-8">
                <section className="w-full">
                  ...
                  <div className="flex flex-col gap-4 text-gray-700">
                    <p>
                      この利用規約（以下，「本規約」といいます。）は，音勉 社労士（以下，「当社」といいます。）がアプリ上で提供するサービス（以下，「本サービス」といいます。）の利用条件を定めるものです。登録ユーザーの皆さま（以下，「ユーザー」といいます。）には，本規約に従って，本サービスをご利用いただきます。
                    </p>
                    ...
                    <p>
                      本サービスの有料コンテンツは2025年版に基づいて提供されます。また，法改正に対応した新たなバージョンの提供が行われる場合，別途料金が発生することがあります。
                    </p>
                    <p>
